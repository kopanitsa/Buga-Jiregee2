...
public class Player implements Serializable {
	...
	public Player(int type) {
		...
		case BugaJiregeePiece.TYPE_DEER:
			...
			for (int i = 0; i < BugaJiregeePiece.NUM_OF_DEERS; i++) {
				this.pieces
						.add(new BugaJiregeePiece(BugaJiregeePiece.TYPE_DEER));
			}
			break;
		case BugaJiregeePiece.TYPE_DOG:
			...
			for (int i = 0; i < BugaJiregeePiece.NUM_OF_DOGS; i++) {
				this.pieces
						.add(new BugaJiregeePiece(BugaJiregeePiece.TYPE_DOG));
			}
			break;
		}
	}
	...
	public boolean equals(Object o) {
		...
		if (key != null ? !key.equals(player.key) : player.key != null)
			return false;
